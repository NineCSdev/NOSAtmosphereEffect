...
Atmo Engine is licensed under the MIT License. The following bundled components retain their own licenses.
...
- Bundled artifact: `app/src/main/assets/models/u2netp_320x320.tflite`
...
The complete model license is included at `app/src/main/assets/models/U2NET_LICENSE.txt`.
